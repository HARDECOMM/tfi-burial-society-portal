  ...
  const faqs = [
    {
      ...
      a: "A waiting period is a standard safety measure for insurance underwriting in South Africa. TFI burial society policy structures apply a 6-month waiting period for death resulting from natural causes (e.g., medical illness). Accidental death has no waiting periods and is covered from your first verified payment."
    },
    {
