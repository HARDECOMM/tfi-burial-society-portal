...
import DignifyLogo from '../components/DignifyLogo';
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-white font-display leading-tight">
              Giving Your Loved Ones A <span className="bg-gradient-to-r from-[#4da3c4] to-teal-400 bg-clip-text text-transparent">Dignified Farewell</span> Deserved
            </h1>
          ...
          <div className="lg:col-span-5 bg-slate-900/60 backdrop-blur-sm border border-slate-800 rounded-2xl p-6 sm:p-8 shadow-xl relative" id="quick-onboarding-promo">
            <div className="flex justify-center mb-6 bg-slate-950/40 p-4 rounded-xl border border-slate-800">
              <DignifyLogo layout="vertical" size="md" invert={true} />
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-3 mb-12">
            ...
            <p className="text-slate-500 text-sm sm:text-base leading-relaxed">
              Dignify Funeral Solutions works directly alongside South Africa's most prominent industrial underwriters to deliver high-integrity funeral support options.
            </p>
          </div>
        ...
        <div className="bg-white rounded-2xl p-8 border border-slate-100 flex flex-col lg:flex-row items-center justify-between gap-8">
          <div className="space-y-2 lg:max-w-md">
            ...
            <p className="text-xs text-slate-500 leading-relaxed">
              Dignify Funeral Solutions policies carry maximum authorization weight. Supported by Old Mutual and RMA ensuring standard claims are settled without compliance delays.
            </p>
          </div>
