...
export default function Contact() {
  ...
  const handleWhatsAppRedirect = () => {
    const textMsg = `Hello Dignify Funeral Solutions, my name is ${formData.fullName || 'Customer'}. I would like to get a custom quote for the ${formData.selectedPlan || 'Funeral Plan'}.`;
          ...
          <div className="lg:col-span-5 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-3.5 items-start">
                  ...
                  <div className="text-left space-y-0.5">
                    ...
                    <a href="mailto:info@dignifyfunerals.co.za" className="text-xs text-brand-blue font-bold hover:underline block">
                      info@dignifyfunerals.co.za
                    </a>
                    <a href="mailto:quotes@dignifyfunerals.co.za" className="text-[11px] text-slate-500 hover:text-brand-blue block">
                      quotes@dignifyfunerals.co.za
                    </a>
                  </div>
                </div>
            ...
            <div className="bg-slate-950 text-white rounded-2xl p-6 border border-slate-905 space-y-4">
              ...
              <p className="text-[11px] text-slate-450 leading-relaxed text-justify">
                Dignify Funeral Solutions is underwritten by Old Mutual Alternative Risk Transfer Limited (OMART) and Rand Mutual Assurance (RMA). Both are licensed life insurance providers. All claims are verified safely in compliance with POPI Act regulations to confirm the payout protection of your registered family unit.
              </p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl border border-slate-200/80 p-6 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-sm">
          ...
          <div className="flex flex-wrap gap-2 shrink-0">
            <a
              href="mailto:claims@dignifyfunerals.co.za"
