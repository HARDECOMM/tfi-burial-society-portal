      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <Link to="/" className="flex items-center space-x-2 group" id="nav-logo">
            ...
            <span className="h-6 w-[1px] bg-white/20 hidden min-[400px]:block mx-1"></span>
            <span className="text-[10px] text-brand-green font-mono uppercase tracking-wider hidden min-[400px]:inline-block bg-brand-green/10 px-2 py-0.5 rounded border border-brand-green/20">
              FSP Portal
            </span>
          </Link>
