...
import DignifyLogo from './DignifyLogo';

export default function Footer() {
  const currentYear = new Date().getFullYear();

  const handleWhatsAppRedirect = () => {
    const textMsg = "Hello Dignify Funeral Solutions, I would like to get more information about your funeral cover and family protection plans.";
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12">
            ...
            <div className="md:col-span-5 space-y-4 text-left">
              <div className="flex items-center space-x-2">
                <DignifyLogo layout="horizontal" size="sm" invert={true} />
              </div>
              <p className="text-xs sm:text-sm text-slate-400 leading-relaxed max-w-sm">
                As a prominent name in South Africa, Dignify Funeral Solutions helps families honor their loved ones with premium-quality funeral cover and Dignified Family Protection. We aim to ease financial burdens in times of sorrow with speed, empathy, and absolute administrative clarity.
              </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4">
            ...
            <div className="border-l-4 border-brand-green pl-4 py-2 bg-slate-900/20 text-justify rounded-r">
              <p className="leading-relaxed text-slate-450 font-medium">
                <strong>LEGAL DISCLAIMER:</strong> Dignify Funeral Solutions (operating under legal registry of TFI Brokers (Pty) Ltd which is a juristic representative operating under House of Administration (Pty) Ltd, an authorised Financial Services Provider FSP No. 50841). Terms &amp; Conditions Apply.
              </p>
            </div>

            <p className="leading-relaxed text-justify text-slate-500">
              Dignify Funeral Solutions operates in strict guidelines with the South African Financial Advisory and Intermediary Services (FAIS) Act, Protection of Personal Information (POPI) Act, and Financial Sector Conduct Authority guidelines. Payout claims are processed within a standard target of 24–48 hours post regulatory certificate registry validations. Standard waiting criteria apply: accidental injuries active immediately on initial payment, 6-month wait period requested on natural illnesses.
            </p>
            ...
            <div className="pt-5 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] border-t border-slate-900 text-slate-600">
              <p>
                &copy; {currentYear} Dignify Funeral Solutions. Registered Desk. SA FSP Partnership Network.
              </p>
